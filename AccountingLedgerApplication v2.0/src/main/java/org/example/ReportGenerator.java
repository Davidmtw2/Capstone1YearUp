...
public class ReportGenerator {
    ...
    public ReportGenerator(TransactionService transactionService) {
        this.transactionService = transactionService;
    }

    public void generateMonthToDateReport() {
        LocalDate startOfMonth = LocalDate.now().withDayOfMonth(1);
        List<Transaction> transactions = transactionService.customSearch(startOfMonth.toString(), LocalDate.now().toString(), "", "", null);
    ...
    public void generatePreviousMonthReport() {
        ...
        List<Transaction> transactions = transactionService.customSearch(startOfPreviousMonth.toString(), endOfPreviousMonth.toString(), "", "", null);
        displayTransactions(transactions, "Previous Month Report");
    }

    public void generateYearToDateReport() {
        LocalDate startOfYear = LocalDate.now().withDayOfYear(1);
        List<Transaction> transactions = transactionService.customSearch(startOfYear.toString(), LocalDate.now().toString(), "", "", null);
    ...
    public void generatePreviousYearReport() {
        ...
        List<Transaction> transactions = transactionService.customSearch(startOfLastYear.toString(), endOfLastYear.toString(), "", "", null);
        displayTransactions(transactions, "Previous Year Report");
    }

    public void searchByVendor(String vendor) {
        List<Transaction> transactions = transactionService.findByVendorIgnoreCase(vendor);
        displayTransactions(transactions, "Search Results for Vendor: " + vendor);
    }

    public void searchByDescription(String description) {
        List<Transaction> transactions = transactionService.findByDescriptionIgnoreCase(description);
        displayTransactions(transactions, "Search Results for Description: " + description);
    }

    private void displayTransactions(List<Transaction> transactions, String reportTitle) {
        System.out.println("\n" + reportTitle);
